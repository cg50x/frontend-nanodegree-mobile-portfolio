...
var resizePizzas = function(size) {
  ...
  function changeClass (size) {
    ...
    pizzaContainer.classList.remove("size-1");
    pizzaContainer.classList.remove("size-2");
    pizzaContainer.classList.remove("size-3");

    if (size === "1") {
      pizzaContainer.classList.add("size-1");
    } else if (size === "2") {
      pizzaContainer.classList.add("size-2");
    } else if (size === "3") {
      pizzaContainer.classList.add("size-3");
    }
  }
